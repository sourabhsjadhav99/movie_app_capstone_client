...
//       dispatch(signInSuccess(token)); // You'll need to define this action in your Redux setup
...
//   return (
//     <div className="flex justify-center items-center bg-[#10141e] h-screen">
//       <div className="container ">
//         <h1 className="text-5xl mb-8 flex items-center justify-center text-[#fc4747]">
//           <MdMovieCreation />
//         </h1>
//         <div className="bg-[#161d2f] shadow mx-auto px-4 py-8 w-2/3 md:w-1/2 lg:w-1/3  rounded-lg drop-shadow-xl ">
//           <h1 className="text-4xl text-white mb-2">Login</h1>
//           <form className="w-full mx-auto py-3" onSubmit={handleSubmit}>
...
//                 className=" block w-full rounded-md border-gray-300 text-white bg-[#161d2f] outline-0 h-[30px]"
//               />
//             </div>
//             <div className="border-b-2 border-[#5a698f] my-4">
//               <input
